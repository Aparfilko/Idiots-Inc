...
func _ready():
	...
	$Camera.current = true
	$car/body/booster/ass.set_surface_material(0,load("res://assets/scene/off.material"))
	$car/body/booster2/ass.set_surface_material(0,load("res://assets/scene/off.material"))
	$car/body/booster3/ass.set_surface_material(0,load("res://assets/scene/off.material"))
	$Dialog.visible = true
